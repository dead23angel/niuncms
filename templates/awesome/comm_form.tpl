...
<div style="text-align:right;position:relative;margin-bottom:-15px;font-size:10px;cursor:pointer;" onclick="reqcomm(0,'',1);"><img src="/templates/system/images/close.png"></div>
...
<table width="160px" height="40px" cellpadding="0" cellspacing="0" border="0px">
	<tr>
		<td>
			<img id="cp1OK" style="position:absolute;display:none;" src="/templates/system/images/capcha/done.png" border="0px">
			<img style="cursor:pointer;" onclick="capcha(1,'[_code0]');" src="[_img0]" border="0px">
		</td>
		<td>
			<img id="cp2OK" style="position:absolute;display:none;" src="/templates/system/images/capcha/done.png" border="0px">
			<img style="cursor:pointer;" onclick="capcha(2,'[_code1]');" src="[_img1]" border="0px">
		</td>
		<td>
			<img id="cp3OK" style="position:absolute;display:none;" src="/templates/system/images/capcha/done.png" border="0px">
			<img style="cursor:pointer;" onclick="capcha(3,'[_code2]');" src="[_img2]" border="0px">
		</td>
		<td>
			<img id="cp4OK" style="position:absolute;display:none;" src="/templates/system/images/capcha/done.png" border="0px">
